...
Path2d.prototype = Object.create( THREE.Shape.prototype );
Path2d.__id = 0;

Path2d.prototype.fromExpression = function( expression )
{
...
Path2d.prototype.addPoint = function(x, y)
{
  throw new Error("Not implemented yet");
  //this.getPoint(x,y);
}

Path2d.prototype.removePoint = function( point )
{
  //throw new Error("Not implemented yet");
...
Path2d.prototype.quadraticCurveTo = function( aCPx, aCPy, aX, aY )
{
...
Path2d.prototype.bezierCurveTo= function(aCP1x, aCP1y, aCP2x, aCP2y, aX, aY)
{
...
Path2d.prototype.arc = function ( aX, aY, aRadius,
 ...
 Path2d.prototype.absarc = function ( aX, aY, aRadius,
									  aStartAngle, aEndAngle, aClockwise ) {
	  this.absellipse(aX, aY, aRadius, aRadius, aStartAngle, aEndAngle, aClockwise);
 };

Path2d.prototype.ellipse = function ( aX, aY, xRadius, yRadius,
									  aStartAngle, aEndAngle, aClockwise ) {
...
Path2d.prototype.absellipse = function ( aX, aY, xRadius, yRadius,
									  aStartAngle, aEndAngle, aClockwise ) {
...
Path2d.prototype.generateVisualControlPoints = function()
{
  ...
  var controlSize = 1.5;
    ...
    pointHelper.name = "Path2dPointHelper";
...
Path2d.prototype.fromThreeShape = function(shape)
{
...
Path2d.prototype.getPoints = function( divisions, closedPath ) {
...
Path2d.prototype.update = function( parameters )
{
...
Path2d.prototype.generateRenderables = function()
{
    var points = this.createPointsGeometry();
...
Path2d.prototype.updateRenderables=function()
{
